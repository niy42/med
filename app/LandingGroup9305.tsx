    ...
    return (
        <div className="relative flex flex-col self-start px-4 md:px-6">
            ...
            <div className="ml-24 flex flex-col-reverse lg:flex-row items-center justify-between w-full max-w-7xl lg:space-x-32">
                {/* Text Section */}
                <div className="relative flex flex-col animate-fade-in gap-6 text-center lg:text-left max-w-2xl">
                    <Text
                        size="textlg_extrabold"
                        as="h1"
                        className=" ml-4 text-4xl lg:text-5xl leading-snug tracking-tight text-blue_gray-900"
                    >
                        Accelerate Your Health <br /> Plans With {" "}
                        <span className="text-light_green-900 font-extrabold">Medinize</span>
                    </Text>
                    <div className="absolute -right-[110px] top-[100px] animate-fade-in">
                        <Img src="vector_green.svg" alt="image" width={450} height={450} className="" />
                    </div>
